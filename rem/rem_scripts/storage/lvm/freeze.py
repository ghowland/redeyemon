...
"""
Storage Function: LVM: Freeze volume (All I/O ops are blocked)

Blocks all I/O ops to this LVM volume
"""
...
def Execute(data=None, state=None):
  ...
  log('TODO(g): Storage:LVM:Freeze: Implement to protect snapshots')
